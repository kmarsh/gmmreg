...
double gmmreg_tps_L2_func::eval(double&f1, double &f2, vnl_matrix<double> &g1, vnl_matrix<double> &g2)
{
    /* L2 version */
    double f = f1 - 2*f2;
    gradient = g1*2 - g2*2;
...
double gmmreg_tps_KC_func::eval(double&f1, double &f2, vnl_matrix<double> &g1, vnl_matrix<double> &g2)
{
    /* -KC^2 version */
    double f21 = f2/f1;
    double f =  - f2*f21;
...
void gmmreg_tps_func::gradf(const vnl_vector<double>& x, vnl_vector<double>& g)
{
