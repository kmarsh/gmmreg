...
int gmmreg_tps::set_init_params(const char* f_config)
{
    ...
    GetPrivateProfileString(common_section, "init_affine", NULL, f_init_affine, 80, f_config);
    set_init_affine(f_init_affine);
    GetPrivateProfileString(common_section, "init_tps", NULL, f_init_tps, 80, f_config);
