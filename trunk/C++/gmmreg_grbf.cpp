...
int gmmreg_grbf::set_init_params(const char* f_config)
{
    ...
    GetPrivateProfileString(common_section, "init_grbf", NULL, f_init_grbf, 80, f_config);
...
void gmmreg_grbf::save_results(const char* f_config, const vnl_vector<double>& params)
{
    ...
    GetPrivateProfileString(common_section, "final_grbf", NULL, f_final_grbf, 255, f_config);
...
void gmmreg_grbf::prepare_own_options(const char* f_config)
{
    ...
    /*
    char s_beta[256]={0};
    GetPrivateProfileString(section, "beta", NULL, s_beta, 255, f_config);
